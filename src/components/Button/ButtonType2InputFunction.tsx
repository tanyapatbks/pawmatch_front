...
export default function ButtonType2InputFunction({
  ...
  return (
    <div
      className="flex flox-row space-x-[8px] px-[24px] py-[8px] justify-center items-center rounded-[32px] bg-rose-600 hover:bg-rose-100 text-[24px]  text-white hover:text-rose-950 hover:cursor-pointer"
      onClick={onClick}
    >
